...
/***/ function(module, exports, __webpack_require__) {
	...
	function home(sources) {
	    ...
	    var vtree$ = route$
	        .map(function (url) {
	        return xs.combine(noun$, topic$, events$, more$, expand$, shorten$, join$, registrationSuccessfulUrl$)
	            .filter(function () { return url === ''; })
	            .map(function (_a) {
	            var noun = _a[0], topic = _a[1], events = _a[2], more = _a[3], expand = _a[4], shorten = _a[5], join = _a[6], registrationSuccessfulUrl = _a[7];
	            ...
	            var children = expandedEvent == undefined
	                ? events_1.topEvents(events).map(function (event) { return event_1.renderEvent(event, join, registrationSuccessfulUrl); }).slice()
	                : [
...
/***/ function(module, exports, __webpack_require__) {
	...
	function renderForm(event, clicked, registrationSuccessful) {
	    var showForm = event.form != undefined && event.registration_time.end_time.getTime() > new Date().getTime();
	    if (!showForm)
	        return [];
	    if (!clicked)
	...
	function renderEvent(event, joinUrl, registrationSuccessfulUrl) {
	    ...
	    ].concat(renderForm(event, clickedBoolean, registrationSuccessful)));
	}

(function() {
  ...
  function registerUser(name, email, phone) {
      $.ajax({
          url: "https://docs.google.com/forms/d/19jtiupDWraGM1d4M8EQDHiaZCCmKt16wq9XOXqWlENY/formResponse",
          data: {
            "entry.710840430" : name,
            "entry.2028895933" : email,
            "entry.310522985": phone},
          type: "POST",
          dataType: "xml",
          crossDomain: true,
          statusCode: {

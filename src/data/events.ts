  ...
  },
{
  ...
  {
    title: 'Understanding Blockchain & Smart Contracts in Etherium - Talk & Hands-on',
    url: 'devday-banglore-21-04',
    categories: ['events'],
    tags: ['blockchain', 'bitcoin', 'etherium', 'consensus', 'smart contracts'],
    author: 'devday_team',
    abstract: 'April edition of Sahaj(Banglore) DevDay is all about block chain. Event is packed with a talk on building crypto currency from scratch - components involved, consensus algorithms, cryptography required and a hands-on about writing smart contracts in Etherium',
    event_time: {
  ...
  {
    title: 'Devday Chennai August 2018',
    url: 'devday-august-18-08',
    categories: ['events'],
    tags: ['blockchain', 'hyperledger'],
    author: 'devday_team',
    abstract: 'In this DevDay we will explore hyperledger with a real use case.',
    event_time: {
      start_time: new Date('2018-08-18T11:00:00+05:30'),
      end_time: new Date('2018-08-18T13:00:00+05:30'),
    },
    publish_time: new Date('2017-09-02T18:30:00+05:30'),
    registration_time: {
      start_time: new Date('2017-09-02T18:30:00+05:30'),
      end_time: new Date('2018-08-18T11:00:00+05:30'),
    },
    venue: CHENNAI_ADDRESS,
    agenda: [
      {
        ...
        authors: [
          {
            name: 'Srimathi, Solution Consultant at Sahaj Software',
            linkedin_profile_url: 'https://www.linkedin.com/in/shrimats/',
            image_url: 'https://media.licdn.com/dms/image/C4D03AQFjftke-pAItA/profile-displayphoto-shrink_800_800/0?e=1539216000&v=beta&t=CyTeKHEBKhhJIAtD0fPyDKzIuEgWavS-n12_8AIZWc8'
          },
          {
            name: 'Shalin, Solution Consultant at Sahaj Software',
            linkedin_profile_url: 'https://www.linkedin.com/in/shalin-lk-a8446272/',
            image_url: 'https://media.licdn.com/dms/image/C4E03AQFrx6mI6wlUdg/profile-displayphoto-shrink_800_800/0?e=1539216000&v=beta&t=FgRjrtLaTghCATBOpnciz7iMQZhoU0Havwb5tSYu8Bk'
          }
        ],
        time: {
          start_time: new Date('2018-08-18T11:00:00+05:30')
      ...
      } as AgendaEntry,
      {
        ...
        authors: [],
        time: {
          start_time: new Date('2018-08-18T13:00:00+05:30')
        }
      } as AgendaEntry,
    ],
    color: '#040509',
